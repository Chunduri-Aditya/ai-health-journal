# GateGuard: callers providers/factory.py. User: Implement the plan as specified. Do NOT edit the plan file.
...
class AnthropicProvider(LLMProvider):
    ...
    def _client(self):
        """Lazy, cached Anthropic SDK client (one instance per provider)."""
        ...
        self._client_instance = anthropic.Anthropic(api_key=self._api_key)
        return self._client_instance
